//#define BLYNK_TEMPLATE_ID "TMPLYjYb89Hr"
//#define BLYNK_DEVICE_NAME "weather"
//#define BLYNK_AUTH_TOKEN "jMxLYu7I5zk92ml8_J15PXhFdKWApede"
#include <WiFi.h>
...
//BlynkTimer timer;
const char* ssid     = "clean";   //your network SSID
...
<html>
    ...
    <body>
        ...
        <label for="resultbar" id="resultlabel"></label><br>
        <progress id="resultbar" value="0" max="100"  style="background-color:blue"> 100% </progress><br>
        <br>
        ...
        async function predict() {
          ...
          if (maxPredictions>0) {
           ...
           // result.innerHTML = data;
            //result.innerHTML += "<br>Result: " + maxClassName + " : " + maxProbability.toFixed(2)*100+"%";
            resultlabel.innerHTML = "Result: " + maxClassName + " : " + maxProbability.toFixed(2)*100+"%";
            resultbar.value = maxProbability.toFixed(2)*100;
